          ...
          <div>
            <div>
              ...
              <h3 className={`${styles.inWait}`}>
                Waiting for {stockAmount} products
              </h3>
              <div>
                {Array.isArray(cart)
                  ? cart.map((product) => (
                ...
                decoded ? (
                  <Link to={`/checkout/${cart[0].orderId}`}>
                    <button className={`${styles.buyButton}`}>
                      CONTINUE SHOPPING <i className="fas fa-money-check"></i>
                    </button>
                  </Link>
                ) : (
                  ...
                  <div>
                    ...
                    >
                      ...
                      <p style={{ color: "white" }}>
                        Log in or register to continue your shopping
                      </p>
                    </Modal>
                  </div>
                )
            ...
            <div>
              ...
              >
                EMPTY CART <i className="fas fa-trash-alt"></i>
              </button>
            </div>
          </div>
        )}
