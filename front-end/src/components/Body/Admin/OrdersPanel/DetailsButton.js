              ...
              {orders &&
                orders.map((order) => (
                  <tr key={order.id}>
                    ...
                    <td className={`${styles.product}`}>{order.amount}</td>
                    <td className={`${styles.product}`}>{order.price}</td>
                    <td className={`${styles.product}`}>{order.size}</td>
                    <td className={`${styles.product}`}>{order.productId}</td>
                  </tr>
                ))}
            </tbody>
          </table>
