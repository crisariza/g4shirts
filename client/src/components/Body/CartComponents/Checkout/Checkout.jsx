  ...
  if (token) {
    return (
      <div className={style.divPadre}>
        <div className={style.div1}>
          <h3 className={style.tituloResumen}>Recipt</h3>
          <div>
            <table>
              <tbody>
                <tr>
                  <th className={style.list}>Product</th>
                  <th className={style.list}>Size</th>
                  <th className={style.list}>Amount</th>
                  <th className={style.list}>Price</th>
                </tr>
                {states.order &&
                  states.order.OrderDetails &&
                  states.order.OrderDetails.map((orderDetail) => (
        ...
        <div className={style.div2}>
          ...
          <div className={style.internDiv2}>
            <label>We'll send it to your address:</label>
    ...
    return (
      <div style={{ marginTop: "3em" }}>
        <label>You must log in or register to continue your shopping.</label>
      </div>
    );
  }
}
