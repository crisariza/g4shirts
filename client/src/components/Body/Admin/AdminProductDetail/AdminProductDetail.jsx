      ...
      <div className={`${styles.ultimo}`}>
        ...
        <div className={`${styles.contTituloprinc}`}>
          ...
          <Link to={`/admin/edit_product/${match.params.id}`}>
            <button className={`${styles.modButt}`}>CHANGE</button>
          </Link>
        </div>
        {/*termina primer div*/}
        ...
        <div className={`${styles.tercDiv}`}>
          <table>
            <thead>
              <tr>
                <th>
                  <h4 className={`${styles.tercDivTit}`}>Categories</h4>
                </th>
                <th></th>
              </tr>
              <select
            ...
            <tbody>
              {product && (
                <tr key={product.id}>
                  ...
                  <td className={`${styles.product}`}>USD {product.price}</td>
                </tr>
              )}
            </tbody>
          </table>
        ...
        <div className={`${styles.sextodeev}`}>
          <h1 className={`${styles.sextodeevTit}`}>Photos</h1>
